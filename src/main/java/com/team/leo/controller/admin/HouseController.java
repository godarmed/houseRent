...
public class HouseController {
     ...
     * @return
     */
    @RequestMapping(value = "delHouseComplete.do")
    public Map<String,Object> delHouseCompletely(@RequestParam(name = "ids") List<String> ids) {
        int deleteNum = 0;
        deleteNum = houseService.deleteByPrimaryKey(ids);
    ...
    public Map<String, Object> updateHouse(House house, @RequestParam(value = "pfile",required = false) CommonsMultipartFile pfile) throws IOException {
        ...
        System.out.println(houseService.selectByPrimaryKey(house.getId()));
        //判断是否有文件上传
        ...
        //更新数据库
        int updateNum = 0;
        updateNum = houseService.updateByPrimaryKey(house);
        Map<String,Object> map = new HashMap<>();
